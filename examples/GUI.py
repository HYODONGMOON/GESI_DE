...
def save_to_excel():
    input_fields = {
        "감축목표": {
            ...
            "min_val": get_cell_value("C:\\Users\\GESI Moon\\Desktop\\python workplace\\GESI_DE - GUI\\examples\\GESI_DE.xlsx", "demand", "K10"),
            "max_val": get_cell_value("C:\\Users\\GESI Moon\\Desktop\\python workplace\\GESI_DE - GUI\\examples\\GESI_DE.xlsx", "demand", "J10")
            },
        "에너지 자급률": {
